...
%SIMULATION MATLAB code file for simulation.fig
...
%
%      SIMULATION('Property','Value',...) creates a new SIMULATION using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to simulation_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      SIMULATION('CALLBACK') and SIMULATION('CALLBACK',hObject,...) call the
%      local function named CALLBACK in SIMULATION.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 09-Jul-2018 15:39:57
